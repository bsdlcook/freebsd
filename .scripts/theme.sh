...
sed -i '' s/$(cat ~/.config/zathura/zathurarc | grep "highlight-color" | awk '{print $3}' | sed s/\"//g)/$accent/ ~/.config/zathura/zathurarc
sed -i '' s/$(cat ~/.config/zathura/zathurarc | grep "recolor-lightcolor" | awk '{print $3}' | sed s/\"//g)/$background/ ~/.config/zathura/zathurarc
sed -i '' s/$(cat ~/.config/zathura/zathurarc | grep "statusbar-fg" | awk '{print $3}' | sed s/\"//g)/$foreground/ ~/.config/zathura/zathurarc
